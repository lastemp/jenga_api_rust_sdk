...
use crate::{
    models::external::mobilemoney::send_to_mobile::{
        AccountFundsTransferResponseData, FundsTransferMobileWalletInputDetails,
    },
    util::util::{build_account_funds_transfer_mobile_wallet_data, build_headers},
};
...
pub async fn transfer(
    ...
    let transfer_data =
        build_account_funds_transfer_mobile_wallet_data(_source, _destination, _transfer);
